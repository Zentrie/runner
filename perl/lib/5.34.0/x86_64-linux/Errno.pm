...
"x86_64-linux-3.10.0-1160.36.2.el7.x86_64" or
	die "Errno architecture (x86_64-linux-3.10.0-1160.36.2.el7.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
